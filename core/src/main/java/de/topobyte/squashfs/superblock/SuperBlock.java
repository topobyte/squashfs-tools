...
import static de.topobyte.squashfs.util.BinUtils.dumpBin;
import static de.topobyte.squashfs.util.BinUtils.DumpOptions.BINARY;
import static de.topobyte.squashfs.util.BinUtils.DumpOptions.DECIMAL;
import static de.topobyte.squashfs.util.BinUtils.DumpOptions.UNIX_TIMESTAMP;
import static de.topobyte.squashfs.util.BinUtils.DumpOptions.UNSIGNED;
...
public class SuperBlock
{
	...
	public static final short DEFAULT_FLAGS = SuperBlockFlag
			.flagsFor(SuperBlockFlag.DUPLICATES, SuperBlockFlag.EXPORTABLE);
	...
	public void readData(DataInput in) throws IOException, SquashFsException
	{
		...
		if (blockSize != expectedBlockSize) {
			throw new SquashFsException(String.format(
					"Corrupt archive, expected block size %d, got %d",
	...
	public String toString()
	{
		...
		dumpBin(buf, width, "directoryTableStart", directoryTableStart,
				DECIMAL);

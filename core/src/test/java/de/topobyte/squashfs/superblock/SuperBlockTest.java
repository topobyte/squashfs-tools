...
import de.topobyte.squashfs.test.SuperBlockTestUtils;
...
public class SuperBlockTest
{
	...
	{
		assertEquals(SuperBlockFlag.flagsFor(SuperBlockFlag.EXPORTABLE,
				SuperBlockFlag.DUPLICATES), sb.getFlags());
	...
	public void writeDataAndReadDataShouldBeReflexive() throws Exception
	{
		...
		assertEquals("Wrong inode count", sb.getInodeCount(),
				sb2.getInodeCount());
